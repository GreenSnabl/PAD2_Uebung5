...
public:
	 ...
	 * is negative. Note that the standard actually supports negative height, but
	 * this implementation does not.
	 * <p> Note that also this uses a LUT, there is currently no way to edit the
...
/*
//A grey Pixel with value 0, can also be used where RgbPixel is applicable
#define BLACK GreyPixel(0)
//A grey Pixel with value 255, can also be used where RgbPixel is applicable
#define WHITE GreyPixel(255)
//A grey Pixel with value 128, can also be used where RgbPixel is applicable
#define GREY GreyPixel(128)
//A grey Pixel with value 64, can also be used where RgbPixel is applicable
#define DARKGREY GreyPixel(64)
//A grey Pixel with value 192, can also be used where RgbPixel is applicable
#define LIGHTGREY GreyPixel(192)

//A RgbPixel with 0,0,255
#define BLUE RgbPixel(0,0,255)
//A RgbPixel with 255,0,0
#define RED RgbPixel(255,0,0)
//A RgbPixel with 0,255,0
#define GREEN RgbPixel(0,255,0)
//A RgbPixel with 0,255,255
#define CYAN RgbPixel(0,255,255)
//A RgbPixel with 255,0,255
#define MAGENTA RgbPixel(255,0,255)
//A RgbPixel with 255,255,0
#define YELLOW RgbPixel(255,255,0)
*/
